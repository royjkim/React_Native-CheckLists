const ADD_TEMPLATE = 'addTemplate',
      ...
      DELETE_INSTANCE_MULTI = 'delInstanceMulti',
      DELETE_INSTANCE_LIST_BY_TEMPLATE_WHEN_DELETE_INSTANCE = 'delInstanceListByTemplateWhenDeleteInstance',
      DELETE_INSTANCE_LIST_BY_TEMPLATE_WHEN_DELETE_TEMPLATE = 'delInstanceListByTemplateWhenDeleteTemplate',
...
const types = {
  ...
  ADD_INSTANCE,
  DELETE_INSTANCE,
  DELETE_INSTANCE_MULTI,
  DELETE_INSTANCE_LIST_BY_TEMPLATE_WHEN_DELETE_INSTANCE,
  MODIFY_INSTANCE,
  ...
  DELETE_INSTANCE_LIST_BY_TEMPLATE_WHEN_DELETE_TEMPLATE,
